...
Route::get('/proprietario/formulario', [App\Http\Controllers\VeiculoController::class, 'formulario'])->name('proprietario-formulario');
Route::post('/proprietario/store', [App\Http\Controllers\VeiculoController::class, 'store'])->name('proprietario-store');
Route::get('/proprietario/listar', [App\Http\Controllers\VeiculoController::class, 'listar'])->name('proprietario-listar');
Route::get('/proprietario/remove/{id}', [App\Http\Controllers\VeiculoController::class, 'remove'])->name('proprietario-remover');
Route::get('/proprietario/editar/{id}', [App\Http\Controllers\VeiculoController::class, 'editar'])->name('proprietario-editar');

Route::get('/anuncio/formulario', [App\Http\Controllers\VeiculoController::class, 'formulario'])->name('anuncio-formulario');
Route::post('/anuncio/store', [App\Http\Controllers\VeiculoController::class, 'store'])->name('anuncio-store');
Route::get('/anuncio/listar', [App\Http\Controllers\VeiculoController::class, 'listar'])->name('anuncio-listar');
Route::get('/anuncio/remove/{id}', [App\Http\Controllers\VeiculoController::class, 'remove'])->name('anuncio-remover');
Route::get('/anuncio/editar/{id}', [App\Http\Controllers\VeiculoController::class, 'editar'])->name('anuncio-editar');
